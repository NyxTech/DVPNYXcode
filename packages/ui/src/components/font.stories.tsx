...
const docs = `### Overview
Loads DVPNYXcode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>DVPNYXcode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>DVPNYXcode Mono Sample</div>
    </div>
  ),
}
