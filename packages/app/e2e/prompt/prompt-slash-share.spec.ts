...
const shareDisabled = process.env.DVPNYXCODE_DISABLE_SHARE === "true" || process.env.DVPNYXCODE_DISABLE_SHARE === "1"
...
test("/share and /unshare update session share state", async ({ page, sdk, gotoSession }) => {
  test.skip(shareDisabled, "Share is disabled in this environment (DVPNYXCODE_DISABLE_SHARE).")
