export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.dvpnyxcode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.dvpnyxcodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par DVPNYXcode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans DVPNYXcode.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.dvpnyxcodeZen.visit.prefix": "Visitez ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans DVPNYXcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans DVPNYXcode.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans dvpnyxcode.json",
  ...
  "dialog.server.description": "Changez le serveur DVPNYXcode auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'DVPNYXcode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe DVPNYXcode",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (dvpnyxcode.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'DVPNYXcode ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "DVPNYXcode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur DVPNYXcode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour DVPNYXcode",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'DVPNYXcode sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'DVPNYXcode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'DVPNYXcode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'DVPNYXcode.",
