...
export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.dvpnyxcode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.dvpnyxcodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "DVPNYXcode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve DVPNYXcode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.dvpnyxcodeZen.visit.prefix": "",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve DVPNYXcode'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak DVPNYXcode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler dvpnyxcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi DVPNYXcode sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "DVPNYXcode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı DVPNYXcode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (dvpnyxcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: DVPNYXcode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "DVPNYXcode Masaüstü",
  ...
  "settings.desktop.wsl.description": "DVPNYXcode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "DVPNYXcode'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "DVPNYXcode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "DVPNYXcode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "DVPNYXcode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "DVPNYXcode'un en son sürümünü kullanıyorsunuz.",
