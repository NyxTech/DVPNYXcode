...
export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.dvpnyxcode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.dvpnyxcodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von DVPNYXcode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in DVPNYXcode zu nutzen.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.dvpnyxcodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.dvpnyxcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in DVPNYXcode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in DVPNYXcode zu nutzen.",
  ...
  "dialog.plugins.empty": "In dvpnyxcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den DVPNYXcode-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von DVPNYXcode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem DVPNYXcode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (dvpnyxcode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: DVPNYXcode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "DVPNYXcode Desktop",
  ...
  "settings.desktop.wsl.description": "DVPNYXcode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für DVPNYXcode ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie DVPNYXcode auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von DVPNYXcode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von DVPNYXcode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von DVPNYXcode.",
