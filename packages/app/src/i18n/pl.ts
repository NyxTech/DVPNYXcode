export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.dvpnyxcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.dvpnyxcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez DVPNYXcode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w DVPNYXcode.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.dvpnyxcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w DVPNYXcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w DVPNYXcode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w dvpnyxcode.json",
  ...
  "dialog.server.description": "Przełącz serwer DVPNYXcode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja DVPNYXcode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu DVPNYXcode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (dvpnyxcode.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, DVPNYXcode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the DVPNYXcode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla DVPNYXcode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd DVPNYXcode na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw DVPNYXcode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania DVPNYXcode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji DVPNYXcode.",
