...
export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "使用 DVPNYXcode Zen 或 API 密钥连接",
  "dialog.provider.dvpnyxcode.tagline": "可靠的优化模型",
  "dialog.provider.dvpnyxcodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "DVPNYXcode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 DVPNYXcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.dvpnyxcodeZen.line1": "DVPNYXcode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.dvpnyxcodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.dvpnyxcodeZen.visit.prefix": "访问 ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 DVPNYXcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 DVPNYXcode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 dvpnyxcode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 DVPNYXcode 服务器。",
  ...
  "toast.update.description": "DVPNYXcode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 DVPNYXcode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (dvpnyxcode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: DVPNYXcode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 DVPNYXcode 服务器。",
  ...
  "settings.general.row.language.description": "更改 DVPNYXcode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 DVPNYXcode 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 DVPNYXcode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 DVPNYXcode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 DVPNYXcode。",
