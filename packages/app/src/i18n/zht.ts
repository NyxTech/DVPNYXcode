...
export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.dvpnyxcode.tagline": "可靠的優化模型",
  "dialog.provider.dvpnyxcodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "DVPNYXcode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 DVPNYXcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.dvpnyxcodeZen.line1": "DVPNYXcode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.dvpnyxcodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.dvpnyxcodeZen.visit.prefix": "造訪 ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 DVPNYXcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 DVPNYXcode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 dvpnyxcode.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 DVPNYXcode 伺服器。",
  ...
  "toast.update.description": "DVPNYXcode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 DVPNYXcode 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (dvpnyxcode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: DVPNYXcode 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 DVPNYXcode 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 DVPNYXcode 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 DVPNYXcode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 DVPNYXcode 啟動時自動檢查更新",
