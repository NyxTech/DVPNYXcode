export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.dvpnyxcode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.dvpnyxcodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por DVPNYXcode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en DVPNYXcode.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.dvpnyxcodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.dvpnyxcodeZen.visit.prefix": "Visita ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en DVPNYXcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en DVPNYXcode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en dvpnyxcode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de DVPNYXcode se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de DVPNYXcode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de DVPNYXcode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (dvpnyxcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, DVPNYXcode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor DVPNYXcode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para DVPNYXcode",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve DVPNYXcode en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de DVPNYXcode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia DVPNYXcode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de DVPNYXcode.",
