export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.dvpnyxcode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.dvpnyxcodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "DVPNYXcodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、DVPNYXcodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.dvpnyxcodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.dvpnyxcodeZen.visit.prefix": " ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してDVPNYXcodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、DVPNYXcodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "dvpnyxcode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するDVPNYXcodeサーバーを切り替えます。",
  ...
  "toast.update.description": "DVPNYXcodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをDVPNYXcodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (dvpnyxcode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: DVPNYXcodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でDVPNYXcodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "DVPNYXcodeの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのDVPNYXcodeの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "DVPNYXcodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "DVPNYXcode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "DVPNYXcode は最新バージョンです。",
