...
export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.dvpnyxcode.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.dvpnyxcodeGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.unpaid.freeModels.title": "DVPNYXcode에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 DVPNYXcode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  "provider.connect.dvpnyxcodeZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.dvpnyxcodeZen.visit.prefix": "다음 ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  "provider.connect.oauth.code.visit.prefix": "다음 ",
  "provider.connect.oauth.code.visit.link": "이 링크",
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 DVPNYXcode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 DVPNYXcode에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "dvpnyxcode.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 DVPNYXcode 서버를 전환합니다.",
  ...
  "toast.update.description": "DVPNYXcode의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 DVPNYXcode 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(dvpnyxcode.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: DVPNYXcode는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 DVPNYXcode 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "DVPNYXcode 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 DVPNYXcode가 보이는 방식 사용자 지정",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "DVPNYXcode 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "DVPNYXcode를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 DVPNYXcode를 사용 중입니다.",
