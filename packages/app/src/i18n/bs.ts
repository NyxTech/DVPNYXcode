export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.dvpnyxcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.dvpnyxcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje DVPNYXcode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u DVPNYXcode-u.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.dvpnyxcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u DVPNYXcode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u DVPNYXcode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u dvpnyxcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se DVPNYXcode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija DVPNYXcode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku DVPNYXcode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (dvpnyxcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: DVPNYXcode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni DVPNYXcode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u DVPNYXcode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako DVPNYXcode izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu DVPNYXcode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se DVPNYXcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju DVPNYXcode-a.",
