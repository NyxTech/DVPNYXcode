export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.dvpnyxcode.tagline": "Надежные оптимизированные модели",
  "dialog.provider.dvpnyxcodeGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от DVPNYXcode",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в DVPNYXcode.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.dvpnyxcodeZen.visit.prefix": "Посетите ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в DVPNYXcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в DVPNYXcode.",
  ...
  "dialog.plugins.empty": "Плагины настроены в dvpnyxcode.json",
  ...
  "dialog.server.description": "Переключите сервер DVPNYXcode к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия DVPNYXcode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде DVPNYXcode",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (dvpnyxcode.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что DVPNYXcode пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер DVPNYXcode внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения DVPNYXcode",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как DVPNYXcode выглядит на вашем устройстве",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление DVPNYXcode.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске DVPNYXcode",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию DVPNYXcode.",
