...
export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.dvpnyxcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.dvpnyxcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av DVPNYXcode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i DVPNYXcode.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.dvpnyxcodeZen.visit.prefix": "Besøk ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i DVPNYXcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i DVPNYXcode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i dvpnyxcode.json",
  ...
  "dialog.server.description": "Bytt hvilken DVPNYXcode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av DVPNYXcode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til DVPNYXcode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (dvpnyxcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at DVPNYXcode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør DVPNYXcode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for DVPNYXcode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan DVPNYXcode ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan DVPNYXcode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når DVPNYXcode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av DVPNYXcode.",
