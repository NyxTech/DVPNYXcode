export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.dvpnyxcode.tagline": "Reliable optimized models",
  "dialog.provider.dvpnyxcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by DVPNYXcode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in DVPNYXcode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.dvpnyxcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.dvpnyxcodeZen.visit.prefix": "Visit ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in DVPNYXcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in DVPNYXcode.",
  ...
  "dialog.plugins.empty": "Plugins configured in dvpnyxcode.json",
  ...
  "dialog.server.description": "Switch which DVPNYXcode server this app connects to.",
  ...
  "toast.update.description": "A new version of DVPNYXcode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the DVPNYXcode team",
  ...
  "error.chain.checkConfig": "Check your config (dvpnyxcode.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for DVPNYXcode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how DVPNYXcode looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how DVPNYXcode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when DVPNYXcode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of DVPNYXcode.",
