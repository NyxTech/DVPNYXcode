export const dict = {
  ...
  "dialog.provider.dvpnyxcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.dvpnyxcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.dvpnyxcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo DVPNYXcode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no DVPNYXcode.",
  ...
  "provider.connect.dvpnyxcodeZen.line1":
    "DVPNYXcode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.dvpnyxcodeZen.visit.prefix": "Visite ",
  "provider.connect.dvpnyxcodeZen.visit.link": "dvpnyxcode.ai/zen",
  "provider.connect.dvpnyxcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no DVPNYXcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no DVPNYXcode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em dvpnyxcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor DVPNYXcode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do DVPNYXcode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do DVPNYXcode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (dvpnyxcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: DVPNYXcode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "DVPNYXcode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor DVPNYXcode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do DVPNYXcode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o DVPNYXcode aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o DVPNYXcode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o DVPNYXcode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do DVPNYXcode.",
