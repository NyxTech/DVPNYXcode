import type { Message, Session, TextPart, UserMessage } from "@dvpnyxcode/sdk/v2/client"
import { Avatar } from "@dvpnyxcode/ui/avatar"
import { HoverCard } from "@dvpnyxcode/ui/hover-card"
import { Icon } from "@dvpnyxcode/ui/icon"
import { IconButton } from "@dvpnyxcode/ui/icon-button"
import { MessageNav } from "@dvpnyxcode/ui/message-nav"
...
const DVPNYXCODE_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === DVPNYXCODE_PROJECT_ID ? "https://dvpnyxcode.ai/favicon.svg" : props.project.icon?.override
          }
