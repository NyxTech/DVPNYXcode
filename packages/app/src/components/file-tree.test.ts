...
beforeAll(async () => {
  ...
  mock.module("@dvpnyxcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@dvpnyxcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@dvpnyxcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@dvpnyxcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
