...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DVPNYXCODE_CALLER", () => {
    process.env["DVPNYXCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DVPNYXCODE_CALLER", () => {
    process.env["DVPNYXCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DVPNYXCODE_CALLER", () => {
    process.env["DVPNYXCODE_CALLER"] = "unknown"
