...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/dvpnyxcode.git")).toEqual({ owner: "sst", repo: "dvpnyxcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/dvpnyxcode")).toEqual({ owner: "sst", repo: "dvpnyxcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/dvpnyxcode.git")).toEqual({ owner: "sst", repo: "dvpnyxcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/dvpnyxcode")).toEqual({ owner: "sst", repo: "dvpnyxcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/dvpnyxcode.git")).toEqual({ owner: "sst", repo: "dvpnyxcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/dvpnyxcode")).toEqual({ owner: "sst", repo: "dvpnyxcode" })
})
