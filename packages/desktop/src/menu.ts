    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://dvpnyxcode.ai/docs"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/dvpnyxcode"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/dvpnyxcode/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/dvpnyxcode/issues/new?template=bug_report.yml"),
