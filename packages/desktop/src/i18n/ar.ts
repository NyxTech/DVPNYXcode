export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من DVPNYXcode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق DVPNYXcode",
  ...
  "desktop.cli.error.sidecarMissing": "ملف DVPNYXcode CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
