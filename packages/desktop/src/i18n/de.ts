export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von DVPNYXcode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'dvpnyxcode' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "DVPNYXcode-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das DVPNYXcode CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
