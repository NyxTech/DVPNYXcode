export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av DVPNYXcode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "DVPNYXcode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "DVPNYXcode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
