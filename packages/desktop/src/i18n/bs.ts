export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju DVPNYXcode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} DVPNYXcode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'dvpnyxcode'.",
  ...
  "desktop.menu.help.documentation": "DVPNYXcode Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka DVPNYXcode CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
