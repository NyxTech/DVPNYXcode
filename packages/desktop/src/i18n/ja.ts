export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの DVPNYXcode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "DVPNYXcode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'dvpnyxcode' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "DVPNYXcode ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "DVPNYXcode CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
