export const dict = {
  ...
  "desktop.updater.none.message": "이미 최신 버전의 DVPNYXcode를 사용하고 있습니다",
  ...
  "desktop.updater.downloaded.prompt": "DVPNYXcode {{version}} 버전을 다운로드했습니다. 설치하고 다시 실행할까요?",
  ...
  "desktop.cli.installed.message":
    "CLI가 {{path}}에 설치되었습니다\n\n터미널을 다시 시작하여 'dvpnyxcode' 명령을 사용하세요.",
  ...
  "desktop.menu.help.documentation": "DVPNYXcode 문서",
  ...
  "desktop.cli.error.sidecarMissing": "DVPNYXcode CLI 바이너리가 누락되었습니다. 데스크톱 앱을 다시 설치해 보세요.",
