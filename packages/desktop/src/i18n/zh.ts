export const dict = {
  ...
  "desktop.updater.none.message": "你已经在使用最新版本的 DVPNYXcode",
  ...
  "desktop.menu.help.documentation": "DVPNYXcode 文档",
  ...
  "desktop.cli.error.sidecarMissing": "DVPNYXcode CLI 二进制文件缺失。请尝试重新安装桌面应用程序。",
