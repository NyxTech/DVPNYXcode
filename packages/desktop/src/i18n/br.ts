export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do DVPNYXcode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada em {{path}}\n\nReinicie seu terminal para usar o comando 'dvpnyxcode'.",
  ...
  "desktop.menu.help.documentation": "Documentação do DVPNYXcode",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do DVPNYXcode está ausente. Tente reinstalar o aplicativo de desktop.",
