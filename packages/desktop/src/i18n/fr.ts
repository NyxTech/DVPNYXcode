export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'DVPNYXcode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'dvpnyxcode'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'DVPNYXcode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI DVPNYXcode est manquant. Essayez de réinstaller l'application de bureau.",
