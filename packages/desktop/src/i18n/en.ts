export const dict = {
  ...
  "desktop.menu.help.documentation": "DVPNYXcode Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of DVPNYXcode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'dvpnyxcode' command.",
  ...
  "desktop.cli.error.sidecarMissing": "DVPNYXcode CLI binary is missing. Try reinstalling the desktop app.",
