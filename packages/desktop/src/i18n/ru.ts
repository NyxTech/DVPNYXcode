export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt": "Версия DVPNYXcode {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'dvpnyxcode'.",
  ...
  "desktop.menu.help.documentation": "Документация DVPNYXcode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл DVPNYXcode CLI. Попробуйте переустановить настольное приложение.",
