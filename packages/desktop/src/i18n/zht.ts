export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 DVPNYXcode",
  ...
  "desktop.menu.help.documentation": "DVPNYXcode 文件",
  ...
  "desktop.cli.error.sidecarMissing": "DVPNYXcode CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
