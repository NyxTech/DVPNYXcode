export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de DVPNYXcode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'dvpnyxcode'.",
  ...
  "desktop.menu.help.documentation": "Documentación de DVPNYXcode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de DVPNYXcode. Intenta reinstalar la aplicación de escritorio.",
