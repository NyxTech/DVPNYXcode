export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} DVPNYXcode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'dvpnyxcode'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja DVPNYXcode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego DVPNYXcode CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
