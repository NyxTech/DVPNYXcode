export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af DVPNYXcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af DVPNYXcode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'dvpnyxcode'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "DVPNYXcode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
