...
/**
 * Server configuration for dvpnyxcode serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: dvpnyxcode.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://dvpnyxcode.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://dvpnyxcode.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
