...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/dvpnyxcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/dvpnyxcode...\n")
...
console.log("Fetching npm all-time downloads for dvpnyxcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("dvpnyxcode-ai")
